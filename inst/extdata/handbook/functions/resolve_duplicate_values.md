...
- `x`: List returned by `flatten_submission_records()`, must contain verb{$FlatResponses}
- `multi_counts`: Optional. Output from `count_multivalue_fields()`. If `NULL`,
...
- Prev: [count_multivalue_fields](count_multivalue_fields.md)
- Next: [Next Function](flatten_submission_records.md)
