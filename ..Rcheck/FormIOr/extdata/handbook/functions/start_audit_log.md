...
```r
start_audit_log(file = "audit_log.csv", overwrite = FALSE, quiet = FALSE)
```
...
- (See `?start_audit_log` for return value details.)
...
- Prev: [summarize_response_timeline](summarize_response_timeline.md)
- Next: [Next Function](stop_audit_log.md)
