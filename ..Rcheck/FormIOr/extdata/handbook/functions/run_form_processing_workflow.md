...
- `flat`: A `flatten_submission_records()`-style list with `FlatResponses`.
...
- Prev: [flatten_submission_records](flatten_submission_records.md)
- Next: [Next Function](fetch_form_metadata.md)
